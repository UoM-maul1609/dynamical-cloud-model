	...
	!>@param[in] ipp, jpp, skpp: dims for this block of data
    ...
    subroutine lsm_driver(ntim,dt,l_h,r_h, &
    			ip,jp,kp, &
    			ipp,jpp,kpp, &
		...
		integer(i4b), intent(in) :: ntim,ip,jp,kp, ipp,jpp,kpp, &
						l_h,r_h, ipstart, jpstart, kpstart, tdend, skp
		...
		do n=1,ntim	
			...
			!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			! main solver, tridiagonal systems at each position                          !
			!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			...
			! exchange horizontal                                                        !
			!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		    call exchange_full_wo(ring_comm, id, skp, jpp, ipp, &
							l_h,r_h,l_h,r_h,l_h, r_h,  t, dims,coords)	
		    call exchange_full_wo(ring_comm, id, skp, jpp, ipp, &
							l_h,r_h,l_h,r_h,l_h, r_h,  wg, dims,coords)	
			!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
